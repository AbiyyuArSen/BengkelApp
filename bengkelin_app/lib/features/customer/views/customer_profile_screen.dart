                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      CircleAvatar(
                        radius: 42,
                        backgroundColor: const Color(0xFF2C3B5E), // Lighter navy circle background
                        child: Text(
                          initials,
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            style: TextButton.styleFrom(
                              foregroundColor: const Color(0xFFF2B300),
                              padding: EdgeInsets.zero,
                            ),
                            child: const Row(
                              children: [
                                Icon(Icons.add, size: 16, color: Color(0xFFF2B300)),
                                SizedBox(width: 4),
                                Text(
                                  'Add Vehicle',
                                  style: TextStyle(
                      ...
                      if (profileViewModel.isLoading)
                        ...
                        ...profileViewModel.vehicles.map((vehicle) => Container(
                          ...
                          children: [
                            ...
                            _buildMenuItem(
                              ...
                              onTap: () async {
                                ...
                                final text = 'Halo Admin Bengkelin, saya butuh bantuan terkait penggunaan aplikasi.';
                                ...
                                try {
                                  ...
                                  if (context.mounted) {
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      const SnackBar(content: Text('Gagal membuka WhatsApp. Hubungi support@bengkelin.com')),
                                    );
                                  }
                                }
                              },
                      ...
                      const Center(
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 4),
                            Text(
                              '© 2026 Bengkelin. All rights reserved.',
                              style: TextStyle(color: AppColors.textSecondary, fontSize: 12),
                            ),
                          ],
                        ),
