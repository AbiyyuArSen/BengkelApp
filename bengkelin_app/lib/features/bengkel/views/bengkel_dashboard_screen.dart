...
class _BengkelDashboardScreenState extends State<BengkelDashboardScreen> {
  ...
  void _showProfileDialog(BuildContext context) {
    ...
    final nameCtrl = TextEditingController(text: viewModel.bengkelName);
                ...
                ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (nameCtrl.text.trim().isEmpty ||
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Semua field wajib diisi, minimal pilih 1 hari')),
                      );
                      return;
                    }
              ...
              if (!isUploading)
                ElevatedButton(
                  onPressed: () async {
                    ...
                    try {
                      await viewModel.uploadDocument('document', selectedFile!.bytes!, selectedFile!.name);
                      ...
                      if (context.mounted) {
                        ...
                        viewModel.fetchBengkelStatus(); // Refresh status
                      }
                    } catch (e) {
